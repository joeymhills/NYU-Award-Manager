...
import { editLocation } from "./atoms";
import { Fragment, useEffect } from "react";

interface Props{
  locationProp: string
}
const EditLocationDropdown: React.FC<Props> = ({
  locationProp
}) => {

  const [ location, setLocation ] = useAtom(editLocation)
...
export default EditLocationDropdown; 
