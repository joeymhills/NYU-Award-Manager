...
import { Fragment } from "react";
 ...
 export default function HomeServiceDropdown() {
  ...
  <Menu as="div" className="relative inline-block w-56 sm:w-96 text-left">
      <div>
        <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md text-ellipsis bg-white px-3 py-2 text-sm font-bentonreg text-gray-900 drop-shadow-md ring-1 ring-inset
