...
const componentRef = useRef(null);
  ...
  //       <div className=" flex flex-col gap-5 justify-center align-middle w-236 bg-white rounded-lg border-2 p-10 text-5xl font-bentonbold">
  //         <div className="font-bentonreg flex justify-center items-center text-4xl">
  //           <div>No results found</div>
  //         </div>
  //       </div>
  ...
  console.log(data)
    ...
    <div className="h-px bg-white" />
      <main className="flex min-h-[130vh] flex-col items-center bg-gradient-to-b from-[#f5b246] to-[#501685]">
        <div className="pt-20 container flex flex-col items-center justify-center gap-2 w-9/12 ">
        <div>
        ...
        if(((id.serviceLine == serviceFilter) || (serviceFilter == "")) && ((id.institution == locationFilter) || (locationFilter == ""))) {
          ...
          <>
            ...
            <div className="flex flex-col mb-2 md:mb-4 gap-0 justify-center align-middle w-96 md:w-150 lg:w-200 bg-white rounded-lg border-2 px-8 pb-4 pt-0 font-bentonbold">
                ...
                {nullCheck(id.serviceLine) && (<div className="font-bentonreg pt-2 md:pt-4 text-md truncate"><span className="font-bentonbold">Service Line: </span>{id.serviceLine}</div>)}
                ...
                {id.comments !== "" && (<div className="font-bentonreg pt-2 md:pt-4 text-md truncate"><span className="font-bentonbold">Comments: </span>{id.comments}</div>)}
                {id.frequency !== "" && (<div className="font-bentonreg pt-2 md:pt-4 text-md truncate"><span className="font-bentonbold">Frequency: </span>{id.frequency}</div>)}
                {id.notifDate !== "" && (<div className="font-bentonreg pt-2 md:pt-4 text-md truncate"><span className="font-bentonbold">Notification Date: </span>{id.notifDate}</div>)}
                {id.sourceatr !== "" && (<div className="font-bentonreg pt-2 md:pt-4 text-md truncate"><span className="font-bentonbold">Source Attribution: </span>{id.sourceatr}</div>)}
