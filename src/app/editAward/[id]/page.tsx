...
return(
    <>
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-b from-[#f5b246] to-[#501685]">
        ...
        animate={{ opacity: 1 }}
          className={'flex pt-3 lg:w-200 md:w-150 sm:w-128 w-96 flex-col z-20 ring-1 ring-inset ring-gray-300 rounded-2xl m-2 items-center justify-center mb-32 bg-white drop-shadow-xl'}>
