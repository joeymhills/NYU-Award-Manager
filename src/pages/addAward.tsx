...
const [page,setPage] = useState(1)
  ...
  return(
        <>
          ...
          <AnimatePresence>
            <motion.div className="flex z-10 min-h-screen w-screen flex-col items-center">
              <motion.div
              className={'flex lg:w-200 md:w-150 w-96 flex-col z-20 rounded-2xl m-2 items-center justify-center bg-white drop-shadow-xl'}>
                <div className="flex flex-col pt-3 items-center justify-center"> 
                  ...
                  relative justify-center items-center">
                    <h1 className="font-bentonbold text-[#541A83] md:text-4xl text-3xl py-1 ">Add award</h1>
                  </div>
