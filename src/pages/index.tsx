...
import { SignUp, SignInButton, SignUpButton, SignOutButton, SignIn, useUser, useAuth } from "@clerk/nextjs";
...
const Home: NextPage = () => {
  ...
  // const canView = () => {
  //   if(role == 'admin'){
  //     console.log('error in admin block')
  //     return true} 
  //   else if(role == 'manager'){
  //     console.log('error in manager block')
  //     return true} 
  //   else if(role == 'user'){
  //     console.log('error in user block')
  //     return true} 
  //   else{
  ...
  // const canWrite = () => {if(role == 'admin' || 'manager'){
  //   return true 
  // }}

return(

// if(role == "admin" || "manager" || "user") {
<>
      <Head>
        <title>Awards</title>
    ...
    <div className="w-full h-6 sm:h-8 bg-[#541A83] flex flex-col justify-center items-end">
      <div className="flex flex-row gap-2 sm:gap-4 p-3">
        ...
        <a type="button" className="text-white hover:text-[#f5b246] duration-500 font-bentonreg py-1 text-sm sm:text-lg sm:py-2"><SignOutButton/></a>
      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-b from-[#f5b246] to-[#501685]">
        <div className="container flex flex-col items-center justify-center gap-2 w-9/12 ">
          <div className="hover:cursor-pointer py-4">
            <svg className="fill-current text-white" onClick = {() => router.push("/")} width="142.5px" height="60px" viewBox="0 0 129 55" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 max-w-5xl gap-10">
            ...
            <button type="button" onClick = {() => router.push("/search?q=Hassenfeld")} className="flex flex-col items-center justify-center gap-4 ">
              ...
              <p className="text-white h-5 text-xs lg:text-lg font-bentonbold">Hassenfeld Children’s Hospital</p>
            </button>
            ...
            <div className="flex flex-row justify-center items-center">
              <div className="grid grid-cols-2 pb-32 pt-10 gap-10 max-w-3xl">
