      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-b from-[#f5b246] to-[#501685]">
        <div className="container flex flex-col items-center justify-center gap-2 w-9/12 ">
          <div className="hover:cursor-pointer py-4">
            <svg onClick = {() => router.push("/")} width="95px" height="40px" viewBox="0 0 129 55" fill="#fff" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 max-w-5xl gap-10 ">
            <button type="button" onClick = {() => router.push("/search?q=tisch%20kimmel")} className="flex flex-col items-center justify-center gap-4 ">
              ...
              <p className="text-white h-5 text-xs font-bentonbold">Tisch Hospital and Kimmel Pavilion</p>
            </button>
              <button type="button" onClick = {() => router.push("/search?q=NYU")} className="flex flex-col items-center justify-center gap-4 ">
              <Image src={grid1} className="w-80 shadow-lg" alt={""} />
              <p className="text-white text-xs h-5 font-bentonbold">Institution-Wide Accolades</p>
              </button>
            <button type="button" onClick = {() => router.push("/search?q=-brooklyn")} className="flex flex-col items-center justify-center gap-4 ">
              ...
              <p className="text-white h-5 text-xs font-bentonbold">NYU Langone Hospital—Brooklyn</p>
            </button>
            <button type="button" onClick = {() => router.push("/search?q=Hassenfeld")} className="flex flex-col items-center justify-center gap-4 ">
              ...
              <p className="text-white h-5 text-xs font-bentonbold">Hassenfeld Children’s Hospital</p>
            </button>
            <button type="button" onClick = {() => router.push("/search?q=Orthopedic%20Hospital")} className="flex flex-col items-center justify-center gap-4 ">
              ...
              <p className="text-white h-5 text-xs font-bentonbold">NYU Langone Orthopedic Hospital</p>
            </button>
            <button type="button" onClick = {() => router.push("/search?q=hospital-long%20island")} className="flex flex-col items-center justify-center gap-4 ">
              ...
              <p className="text-white h-5 text-xs font-bentonbold">NYU Langone Hospital—Long Island</p>
            </button>
          ...
          <div className="pb-64">
          <button type="button" onClick = {() => {setShowForm(true)}} className="bg-white font-bentonbold text-xl text-[#541A83] py-2 w-64 rounded-3xl">Submit</button>
        </div>
        </div>
      </main>
    </>
